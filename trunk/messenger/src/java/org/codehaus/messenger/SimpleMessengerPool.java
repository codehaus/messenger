...
/**
 * <p><code>SimpleMessengerPool</code> is a simple implementation of a
 * MessengerPool which creates a new Messenger each time.
 * 
...
public class SimpleMessengerPool extends MessengerPoolSupport {
    ...
    public SimpleMessengerPool(SessionFactory factory) {
        super(factory);
    }
